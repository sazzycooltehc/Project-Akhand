...
export const STATES: Partial<GeoNode>[] = [
  ...
  { name: "Andhra Pradesh", coords: [79.74, 15.91], core: "nagpur" },
  { name: "Arunachal Pradesh", coords: [94.72, 28.21], core: "dhaka" },
  { name: "Assam", coords: [92.93, 26.2], core: "dhaka" },
  { name: "Bihar", coords: [85.31, 25.09], core: "dhaka" },
  { name: "Chhattisgarh", coords: [81.86, 21.27], core: "nagpur" },
  { name: "Goa", coords: [74.12, 15.29], core: "nagpur" },
  ...
  { name: "Karnataka", coords: [75.71, 15.31], core: "nagpur" },
  { name: "Kerala", coords: [76.27, 10.85], core: "nagpur" },
  { name: "Madhya Pradesh", coords: [78.65, 22.97], core: "nagpur" },
  { name: "Maharashtra", coords: [75.71, 19.75], core: "nagpur" },
  { name: "Manipur", coords: [93.9, 24.66], core: "dhaka" },
  { name: "Meghalaya", coords: [91.36, 25.46], core: "dhaka" },
  { name: "Mizoram", coords: [92.93, 23.16], core: "dhaka" },
  { name: "Nagaland", coords: [94.56, 26.15], core: "dhaka" },
  ...
  { name: "Sikkim", coords: [88.51, 27.53], core: "dhaka" },
  { name: "Tamil Nadu", coords: [78.65, 11.12], core: "nagpur" },
  { name: "Telangana", coords: [79.01, 18.11], core: "nagpur" },
  { name: "Tripura", coords: [91.98, 23.94], core: "dhaka" },
  ...
  { name: "Khyber Pakhtunkhwa", coords: [71.5, 34.0], core: "karachi" },
  { name: "Punjab West", coords: [72.5, 31.0], core: "karachi" },
  { name: "Nepal", coords: [84.1, 28.3], core: "dhaka" },
  { name: "Sri Lanka", coords: [80.7, 7.8], core: "nagpur" },
  { name: "Bangladesh", coords: [90.0, 23.7], core: "dhaka" },
  { name: "Bhutan", coords: [90.43, 27.51], core: "dhaka" },
...
export const UTS: Partial<GeoNode>[] = [
  ...
  { name: "Jammu & Kashmir", coords: [74.79, 34.08], core: "delhi" },
